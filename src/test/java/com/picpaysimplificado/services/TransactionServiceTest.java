...
class TransactionServiceTest {
    ...
    void createTransactionCase1() throws Exception {
        User sender = new User(1L, "Maria", "Silva", "99999999901", "maria@email.com", "123456", new BigDecimal(10), UserType.COMMON);
        User receiver = new User(2L, "Roberto", "Nobrega", "99999999902", "roberto@email.com", "123456", new BigDecimal(10), UserType.MERCHANT);
